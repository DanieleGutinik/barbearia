...
public class Banco {
    ...
    public static void inicia(){
        ...
        Cliente cliente1 = new Cliente(1, 
					...
					"30/01/1995", 
		                        "30212126",
		                        "daniele123.h607@gmail.com", 
		                        "5142487", 
			                "Rua jaboti 35 Canudos NH",  
					"93300012");
        ...
        Cliente cliente2 = new Cliente(2, 
				        ...
				        'F', 
		                        "30/08/1994", 
			                "30212127", 
		                        "juditeoliveirapet@gmail.com", 
				        "5142487745", 
					"Rua campo bom 78 Centro NH",  
					"93300045");
        ...
        Cliente cliente3 = new Cliente(3, 
					...
					"24/04/1997", 
					"30212128", 
					"pauloricardopet@gmail.com", 
					"78451458", 
					"Rua Tres Irmaos 30 Vila Nova - NH",  
					"933007496");
        Cliente cliente4 = new Cliente(4, 
					...
					"20/08/1995", 
					"30212130", 
					"neymarsantospet@gmail.com", 
					"2745487", 
					"Rua Lombardi 40 Canudos NH",  
					"93300748");
        Cliente cliente5 = new Cliente(5, 
					...
					"13/09/1992", 
					"30212131", 
					"debruinepet@gmail.com", 
					"4742487", 
					"Rua pedro quaresma 784 Canudos Belgica", 
					"933000847");
        Cliente cliente6 = new Cliente(6, 
					"Matuidi Pareira", 
					'M', "17/08/1994", 
					"302122324", 
					"matuidipet@gmail.com", 
					"78512457",
					"Rua champions 10 Kephas Franca", 
					"933000782");
        Cliente cliente7 = new Cliente(7,
					...
					"25/03/1993", 
					"302121292", 
					"martasouzapet@gmail.com", 
					"4658237314", 
					"Rua tesla 215 Canudos NH",  
					"93352012");
        Cliente cliente8 = new Cliente(8, 
					...
					"04/03/1990", 
					"302121451", 
					"alineferraripet@gmail.com", 
					"8475123687", 
					"Rua hyrule 32 Canudos NH",  
					"9334714747");
        Cliente cliente9 = new Cliente(9, 
					...
					"09/02/1998", 
					"302121189", 
					"samuelcoltinhopet@gmail.com", 
					"74595142487", 
					"Rua floresta 12 Canudos NH",  
					"9330046364");
        Cliente cliente10 = new Cliente(10, 
					...
					"12/06/1999", 
					"3021212478", 
					"felipeluispet@gmail.com", 
		                        "845713647", 
					"Rua marechal 1023 Canudos NH",  
					"933000874");
        ...
        Agendamento agendamento2 = new Agendamento(2, cliente2, servico4, 40, "14/07/2018 10:00");
        Agendamento agendamento3 = new Agendamento(3, cliente3, servico1, 18, "14/07/2018 10:30");
	Agendamento agendamento4 = new Agendamento(4, cliente4, servico1, 18, "14/07/2018 10:30");
	Agendamento agendamento5 = new Agendamento(5, cliente7, servico2, 30, "14/07/2018 09:30");
        Agendamento agendamento6 = new Agendamento(6, cliente8, servico4, 40, "14/07/2018 10:00");
        Agendamento agendamento7 = new Agendamento(7, cliente9, servico1, 18, "14/07/2018 10:30");
	Agendamento agendamento8 = new Agendamento(8, cliente10, servico1,18, "14/07/2018 10:30");
	...
	agendamento.add(agendamento4);
        ...
        agendamento.add(agendamento7);
	agendamento.add(agendamento8);
    }
